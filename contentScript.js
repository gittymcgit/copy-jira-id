...
function getButtonParent(){
    const idContainers = document.getElementsByClassName('BreadcrumbsItem__BreadcrumbsItemElement-sc-1hh8yo5-0');
...
var observer = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
        ...
        for (var i = 0; i < mutation.addedNodes.length; i++) {
            if (mutation.addedNodes[i].classList.contains("BreadcrumbsItem__BreadcrumbsItemElement-sc-1hh8yo5-0")) {
                refresh()
            }
        }
    });
